...
const repoPath = `https://raw.githubusercontent.com/leozinndelas/Khanverixs/refs/heads/${isDev ? "dev/" : "main/"}`;
...
document.querySelector("link[rel~='icon']").href = 'https://cdn.discordapp.com/attachments/1196384322400301167/1404925612229136434/monogram-kv-logo-icon-unique-kv-logo-letter-stock-vector.jpg?ex=689cf670&is=689ba4f0&hm=f19660d8d14469906899ecd15e819c66bb8cf073ef77368c714f1eb24423d34c&';
...
/* Inject */
if (!/^https?:\/\/([a-z0-9-]+\.)?khanacademy\.org/.test(window.location.href)) { alert("❌ Khanverix Failed to Injected!\n\nVocê precisa executar o Khanverix no site do Khan Academy! (https://pt.khanacademy.org/)"); window.location.href = "https://pt.khanacademy.org/"; }
